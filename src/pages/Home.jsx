...
export default function Home() {
  const navSections = [
    ...
    {
      title: 'Projects',
      description: 'Data science and engineering projects',
      path: '/projects',
    },
    {
      title: 'Skills',
        ...
        <div className="container hero__content">
          ...
          <div className="hero__nav-grid">
            {navSections.map((section, idx) => (
              ...
              >
                <div className="hero__nav-card-title">{section.title}</div>
                <div className="hero__nav-card-desc">{section.description}</div>
              </Link>
            ))}
          </div>
